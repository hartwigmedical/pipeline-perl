...
sub setupDoneFiles {
    ...
    my @done_files = map { catfile($output_dir, $_) } (
        ...
        catfile("logs", "GermlineCaller.done"),
        catfile("logs", "GermlineAnnotation.done"),
        catfile("logs", "GermlineFilter.done"),
        catfile("CPCT12345678R", "logs", "CPCT12345678R_HJJLGCCXX_S1_L001_001_bwa.done"),
        ...
        catfile("CPCT12345678R", "logs", "PreStats_CPCT12345678R.done"),
        ...
        catfile("CPCT12345678R", "mapping", "CPCT12345678R_HJJLGCCXX_S1_L001_001.done"),
        catfile("CPCT12345678T", "logs", "PreStats_CPCT12345678T.done"),
        ...
        catfile("CPCT12345678T", "logs", "CPCT12345678T_HJJLGCCXX_S1_L001_001_bwa.done"),
        ...
        catfile("CPCT12345678T", "mapping", "CPCT12345678T_HJJLGCCXX_S1_L001_001.done"),
